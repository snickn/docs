...
**Role Summary:**  
Supports the product organization by driving process efficiency, optimizing Azure DevOps usage, and improving team coordination to increase delivery velocity.

**Core Responsibilities:**
- Facilitate and document recurring product ceremonies (e.g., roadmap reviews, planning sessions, retrospectives).
- Manage and optimize work item workflows in Azure DevOps.
- Tag and notify related stakeholders on relevant user stories and work items.
- Assist team members in unblocking work to improve throughput and velocity.
- Coordinate release readiness and cross-functional alignment.
- Maintain templates, tools, and shared documentation for consistent practices.
- Track and report on initiative progress and OKRs.
- Support onboarding and training for new product team members.

**Key Collaboration Points:**
- Product Owners and Scrum Masters for backlog hygiene and ceremony facilitation.
- Engineers and Business Analysts for day-to-day coordination.
- Head of Product for reporting, metrics, and continuous improvement.

**Success Metrics:**
- Improved visibility and accuracy of Azure DevOps boards.
- Reduction in blockers and increased delivery velocity.
- Consistent execution of product team rituals and workflows.
...
**Role Summary:**  
Elevates the overall user experience across all products by driving ideation, visual polish, and UX quality. Serves as the champion for user experience, ensuring every product feels intuitive, refined, and aligned with a higher standard of design excellence.

**Core Responsibilities:**
- Lead UX strategy for new product ideation and concept development.
- Raise the bar on UX quality across all products by identifying and addressing design gaps.
- Own the creation of visual illustrations, design assets, and interactions that enhance usability and delight.
- Provide feedback and guidance to product and engineering teams to ensure UX best practices are followed.
- Standardize design patterns and promote design consistency across teams.
- Collaborate closely with Product and Engineering to ensure feasibility and execution of high-quality interfaces.

**Key Collaboration Points:**
- Product Owners and BAs during early-stage concepting and validation.
- Designers and Engineers to deliver final polish and ensure user-focused implementation.
- Head of Product to align on priorities and advocate for the voice of the user.

**Success Metrics:**
- Measurable improvements in product usability and customer satisfaction.
- Consistent visual and interaction quality across all products.
- Increased adoption of UX best practices by product and engineering teams.
